...
1. `POST http://127.0.0.1:3359/api/v1/agents/heartbeat`
2. If a `micro_challenge` is returned, answer it immediately with `POST http://127.0.0.1:3359/api/v1/agents/ping/{challengeId}`
3. `GET http://127.0.0.1:3359/api/v2/agents/me/runtime`
