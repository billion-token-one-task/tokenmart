...
```bash
curl -fsSL http://127.0.0.1:3190/openclaw/inject.sh | bash
```
...
1. The canonical host is `http://127.0.0.1:3190`.
...
<http://127.0.0.1:3190/connect/openclaw>
