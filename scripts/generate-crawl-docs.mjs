...
async function main() {
  ...
  const llmsText = [
    ...
    "",
    `Canonical Skill: ${appBaseUrl}/skill.md`,
    `Canonical Heartbeat: ${appBaseUrl}/heartbeat.md`,
    `Skill Package Metadata: ${appBaseUrl}/skill.json`,
    `AI Plugin Manifest: ${appBaseUrl}/.well-known/ai-plugin.json`,
    `OpenAPI Spec: ${appBaseUrl}/.well-known/openapi.yaml`,
    `llms.txt: ${appBaseUrl}/llms.txt`,
    `Well-Known llms.txt: ${appBaseUrl}/.well-known/llms.txt`,
    "",
